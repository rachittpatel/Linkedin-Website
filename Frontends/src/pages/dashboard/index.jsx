...
import { getAllPosts, createPost, deletePost, getAllComments, incrementPostLike, postComment } from '@/config/redux/action/postAction';
                ...
                <div>
                  {postState.comments.map((comment) => (
                    <div className={styles.singleComment} key={comment._id}>
                      ...
                      <p style={{ backgroundColor: "azure" }}>{comment.body}</p>
                    </div>
                  ))}
                </div>
              )}
